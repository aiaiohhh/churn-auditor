...
/**
 * V5 Scene 11: Closing — logo, features, tagline, Gemini badge. No competition badge.
 * 450 frames (15s).
 */
export const V5CloseScene: React.FC = () => {
  ...
  // Three feature icons — rapid stagger
  const features = [
    { icon: "⚡", label: "60s AI Diagnosis", delay: 0.6 },
    { icon: "🔄", label: "Automated Recovery", delay: 0.8 },
    { icon: "📊", label: "Real-time Analytics", delay: 1.0 },
  ];

  // Dramatic pause before tagline
  ...
  // Gemini badge
  const badgeOpacity = interpolate(frame, [4.5 * fps, 4.8 * fps], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
